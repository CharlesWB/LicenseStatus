...
namespace MockUtil
{
    ...
    /// </summary>
    public class LmStatErrors : StatusWriter
    {
        /// <summary>
        ...
        public LmStatErrors() : base()
        {
            ...
            this.Vendor = "theorem";
            this.ReportDate = new DateTime(2008, 11, 20);
        }
        ...
        public override void CreateReport()
        {
            ...
            this.WriteLine("Flexible License Manager status on {0:ddd M/d/yyyy} 15:42", this.ReportDate);
            this.WriteLine();
