// <copyright file="LmStatWriterBase.cs" company="Charles W. Bozarth">
...
namespace LmStatReportGenerator
{
    ...
    /// </summary>
    public abstract class LmStatWriterBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LmStatWriterBase"/> class.
        /// </summary>
        public LmStatWriterBase()
        {
        ...
        /// <summary>
        /// Gets or sets the stream to which the report is written to.
        /// </summary>
        /// <remarks>If not set then the report is written to the console instead.</remarks>
