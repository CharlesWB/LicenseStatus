// <copyright file="ZeroGroupNameToNoneConverter.cs" company="Charles W. Bozarth">
...
namespace LicenseStatus
{
    ...
    public class ZeroGroupNameToNoneConverter : IValueConverter
    {
        /// <summary>
        ...
        /// <returns>The string "None" if the value is zero, otherwise the original value.</returns>
