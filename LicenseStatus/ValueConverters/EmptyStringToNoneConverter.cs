// <copyright file="EmptyStringToNoneConverter.cs" company="Charles W. Bozarth">
...
namespace LicenseStatus
{
    ...
    /// <summary>
    /// Takes a string and converts it to "None" if it is empty. Otherwise returns the value.
    /// </summary>
    ...
    public class EmptyStringToNoneConverter : IValueConverter
    {
        ...
        /// <returns>The string "None" if the value is empty, otherwise the original value.</returns>
